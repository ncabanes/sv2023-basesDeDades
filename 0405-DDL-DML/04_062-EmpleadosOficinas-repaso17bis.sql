...
-- 59. Muestra, en una misma columna, el apellido y el nombre de cada empleado, en el formato "Apellido, Nombre".

-- 60. Añade un empleado sin oficina, como el siguiente. Luego muestra el nombre de cada empleado, su apellido y el código de su oficina. Si algún empleado no tiene oficina, deberás escribir en "(No en activo)" en lugar del código de oficina.
